package property.classtest.example.com.example.classtest.property;
...
import property.classtest.example.com.example.classtest.drawableanim.DrawableAnim;
import property.classtest.example.com.example.classtest.transition.Transition;
import property.classtest.example.com.example.classtest.viewanim.ViewAnim;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_transition://点击Start Layout Transition Anim
                Log.i("aaa","eeee");
                intent = new Intent(CodeAnim.this, Transition.class);
                startActivity(intent);//启动Acitivity
                break;
        }
    }
